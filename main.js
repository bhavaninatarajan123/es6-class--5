...
class Manager extends Employee{
    ...
    display(){
        ...
        let y =(this.salary +this.bonus)
            console.log(`I am ${this.name},my salary per month is ${this.salary},my department is ${this.department} and my bonus is${this.bonus},finally my salary with bonus is ${y}` );
    }
